...
def write_flags(flag_fn, fasta_fn, xml_fn, silent_fn):
    ...
    flag_file.write("-score:weights /PATH/TO/ROSETTAGPCR/rosettagpcr/scripts/stage3_rlx_membrane.wts\n")
...
def write_xml(fn, template_filenames):
    ...
    xml_file.write("        <ScoreFunction name=\"stage1\" weights=\"/PATH/TO/ROSETTAGPCR/rosettagpcr/scripts/stage1_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"1\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    xml_file.write("        <ScoreFunction name=\"stage2\" weights=\"/PATH/TO/ROSETTAGPCR/rosettagpcr/scripts/stage2_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"0.5\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    xml_file.write("        <ScoreFunction name=\"fullatom\" weights=\"/PATH/TO/ROSETTAGPCR/rosettagpcr/scripts/stage3_rlx_membrane.wts\" symmetric=\"0\">\n")
    xml_file.write("            <Reweight scoretype=\"atom_pair_constraint\" weight=\"0.5\"/>\n")
    xml_file.write("        </ScoreFunction>\n")
    ...
    xml_file.write("        <Hybridize name=\"hybridize\" stage1_scorefxn=\"stage1\" stage2_scorefxn=\"stage2\" fa_scorefxn=\"fullatom\" batch=\"1\" stage1_increase_cycles=\"1.0\" stage2_increase_cycles=\"1.0\" linmin_only=\"1\" realign_domains=\"0\" disulf_file=\"%s/disulf.txt\">\n"%run_dir)
...
if __name__=="__main__":
    ...
    if (not os.path.exists("hybrid/hybridize0_C1.xml")):
        ...
        if not args.run:
            ...
            print "BUT FIRST: Ensure span file and disulfide file are in rosetta_cm directory"
            print "CHECK ALL PATHS IN ALL FILES"
            sys.exit(-1)
        else:
